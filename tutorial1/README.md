...
number.
12.	Input 4 integers (+ve and −ve). Write a Python code to find the sum of
...
20.	Write a Python code to determine whether the given string is a Palindrome or not
